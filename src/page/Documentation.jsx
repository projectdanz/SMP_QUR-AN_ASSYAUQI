...
const Documentation = () => {
  ...
  return (
    <main className="py-20 px-4 bg-white min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative">
        <div className="text-center mb-20">
          <h1 className="text-4xl md:text-5xl font-extrabold text-[#006DB8] mb-6 tracking-tight">
        ...
        <div className="space-y-24">
          {/* MHQ Section */}
          <section id="acara-mhq" className="scroll-mt-32">
          ...
          {/* Horsebow Section */}
          <section id="horsebow" className="scroll-mt-32">
            <div className="flex items-center gap-4 mb-10">
              <h2 className="text-3xl font-bold text-[#006DB8]">
                Kegiatan Horsebow
              </h2>
          ...
          {/* Berenang Section */}
          <section id="berenang" className="scroll-mt-32">
            <div className="flex items-center gap-4 mb-10">
              <h2 className="text-3xl font-bold text-[#006DB8]">
                Kegiatan Berenang
              </h2>
